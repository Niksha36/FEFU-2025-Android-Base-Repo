...
class CustomLayout @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            /** measureChild - даёт знать каждому айтаму его размеры с учетом его характеристик
             * таких как match parent или wrap content и относительно родительских элементов
             * */
        ...
        /** setMeasuredDimension - вернет итоговые размеры нашего контейнера с учетом нового эл-та */
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            /** child.layout() - размещает наш айтем на лейауте */
